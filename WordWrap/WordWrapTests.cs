...
namespace KataWordWrap
{
    public class WordWrapTests
    {
        ...
        {
            Check.That(WordWrap.Wrap(input, columnNumber)).IsEqualTo(expected);
        }
    }
}
